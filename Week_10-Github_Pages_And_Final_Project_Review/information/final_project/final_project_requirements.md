...
- Demonstrate that you have taken the appropriate steps to plan and build your website by submitting all milestones by their due dates:
  - Project Proposal / Wireframes - 4/12 
  - Draft of HTML / CSS (no JS) - 4/19
  - First draft of JS - 4/26
  - Updated Rough Draft - 4/28
...
| ------------- |:-------------:| -----:|
| Milestone 1 | 4/12 | Project Proposal / Wireframes |
| Milestone 2 | 4/19 | Draft of HTML / CSS (no JS) |
| Milestone 3 | 4/26 | First draft of JS |
| Milestone 4 | 4/28 | Updated Rough Draft |
...
Students will create a new repository on GitHub for their final project and push their code to this new repository when they are ready to submit. The instructional team will grade each technical requirement and provide a numeric grade on a scale: does not meet expectations (0); meets expectations (1); exceeds expectations (2).  **Note**: If bullet points have child bullets, the instructional team should grade the child bullets and not the parent bullet belonging to the child. The maximum possible score on this assignment is 24/24. Bonus sections are completely optional.
